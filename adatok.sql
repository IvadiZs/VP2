...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Már 14. 09:00
...
--
CREATE DATABASE IF NOT EXISTS `euroskills` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `euroskills`;
...
CREATE TABLE `orszag` (
  ...
  `orszagNev` varchar(31) DEFAULT NULL
...
CREATE TABLE `szakma` (
  `id` varchar(2) NOT NULL,
  `szakmaNev` varchar(31) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `versenyzo` (
  `id` int(11) NOT NULL,
  `nev` varchar(31) DEFAULT NULL,
  `szakmaId` varchar(2) DEFAULT NULL,
  `orszagId` varchar(2) DEFAULT NULL,
...
--
ALTER TABLE `versenyzo`
  ADD CONSTRAINT `versenyzo_ibfk_1` FOREIGN KEY (`szakmaId`) REFERENCES `szakma` (`id`) ON DELETE CASCADE,
